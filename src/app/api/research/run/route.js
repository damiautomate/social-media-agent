...
import { createResearchJob, hasActiveResearchJob, getUser } from "@/lib/content-bank.js";
...
export async function POST(request) {
  ...
  if (await hasActiveResearchJob(auth.userId)) return NextResponse.json({ error: "A research run is already in progress." }, { status: 429 });
